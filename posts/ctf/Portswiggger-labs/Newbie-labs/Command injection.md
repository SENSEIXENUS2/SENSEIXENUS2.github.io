...
- I tested both fields with linux shell command but I got no output back.So I used semi-colon before the commands. and it worked.I also noticed that both parameters are vulnerable
